          ...
          <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
            ...
            <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
              ...
              <h2 className="focus:outline-none text-gray-400 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">
               Building the meme ecosystem, 333 tokens MEME.</h2>
            </div>
          ...
          <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
            ...
            <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
              ...
              <h2 className="focus:outline-none text-gray-400 mt-3 text-base leading-6 tracking-wide">
                The era of Rebase is over, but Chinchilla will start a new revolution with Debase tokens, issuing NFT to acknowledge our most loyal fans.</h2>
            </div>
        ...
        <div className="md:hidden flex flex-col items-center w-full">
          ...
          <div className="mt-10">
            ...
            <h2 className="text-gray-400 mt-3 text-center text-base leading-6 tracking-wide">
              The chinchilla population is decreasing at a terrifying rate of 0.001% per block, which means the total number of chinchillas will
decrease by 7% in just one day.
            </h2>
          </div>
          <svg
            className="my-10"
