...
export default function Home() {
  ...
  return (
    <div className="min-h-screen h-full w-full flex flex-col bg-[#101233] overflow-hidden">
      ...
      <header id='#top' className="min-w-full text-gray-800 py-4 md:py-14 px-4 md:px-0 bg">
        <div className="flex items-center container mx-auto justify-between px-3.5 md:px-28 h-full">
          {/* Logo */}
          <Image onClick={onBackHome} width={190} height={40} alt='' src='/images/logo.png' />
